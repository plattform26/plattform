  ...
  return (
    <div className="min-h-screen bg-[#070d1a] text-white">
      ...
      <nav className="flex items-center justify-between px-10 h-16 bg-[#0a1f44] border-b border-blue-500/20 sticky top-0 z-50">
        <Link href={user ? (user.role === 'ADMIN' ? '/dashboard/admin' : user.role === 'INSTRUCTOR' ? '/dashboard/instructor' : '/dashboard/student') : "/"} className="flex items-center gap-2 font-space-grotesk font-bold text-lg tracking-wider">
      ...
      {/* HERO */}
      <header className="relative py-24 px-10 flex items-center overflow-hidden min-h-[540px]">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_60%_40%,rgba(59,130,246,0.18)_0%,transparent_70%),radial-gradient(ellipse_50%_50%_at_20%_80%,rgba(6,182,212,0.12)_0%,transparent_60%)]"></div>
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-gray-400 text-lg mb-8 font-light max-w-lg leading-relaxed">
      ...
      {/* CATALOG */}
      <section id="catalogo" className="py-16 px-10">
        ...
        <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
          {['', 'BUSINESS', 'TECHNOLOGY', 'MARKETING', 'FINANCE'].map(cat => (
             <button 
                ...
                className={`px-4 py-1.5 rounded-full text-sm font-medium border transition-all whitespace-nowrap ${category === cat ? 'bg-gradient-to-r from-cyan-500 to-blue-600 border-transparent text-white shadow-[0_2px_10px_rgba(59,130,246,0.3)]' : 'bg-transparent border-blue-500/20 text-gray-400 hover:bg-blue-500/10'}`}
             >
               {cat === '' ? 'Todos' : cat}
             </button>
          ))}
        ...
        {loading ? (
          ...
          <div className="text-center py-20 text-gray-500 bg-[#152035] rounded-xl border border-blue-500/10">No se encontraron cursos con estos filtros.</div>
        ) : (
      ...
      {/* POR QUÉ PLATTFORM */}
      <section className="py-20 px-10 bg-[#070d1a]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
             ...
             <p className="text-gray-400 max-w-2xl mx-auto">La única plataforma que incluye herramientas de inteligencia artificial y cobro automático en un solo lugar.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-[#152035] border border-blue-500/20 p-6 rounded-2xl hover:border-cyan-500/30 transition-colors">
               ...
               <p className="text-gray-400 text-sm">Genera módulos, lecciones y evaluaciones en segundos</p>
            </div>
            <div className="bg-[#152035] border border-blue-500/20 p-6 rounded-2xl hover:border-cyan-500/30 transition-colors">
               <div className="text-3xl mb-4">💰</div>
               <h3 className="font-bold text-lg mb-2">Monetización directa</h3>
               <p className="text-gray-400 text-sm">El dinero llega directo a tu cuenta vía Stripe</p>
            </div>
            <div className="bg-[#152035] border border-blue-500/20 p-6 rounded-2xl hover:border-cyan-500/30 transition-colors">
               <div className="text-3xl mb-4">🎓</div>
               <h3 className="font-bold text-lg mb-2">Certificados automáticos</h3>
               <p className="text-gray-400 text-sm">Al completar y aprobar, el alumno recibe su certificado</p>
            </div>
            <div className="bg-[#152035] border border-blue-500/20 p-6 rounded-2xl hover:border-cyan-500/30 transition-colors">
               <div className="text-3xl mb-4">📊</div>
               <h3 className="font-bold text-lg mb-2">Dashboard de negocio</h3>
               <p className="text-gray-400 text-sm">Visualiza ingresos y monitorea alumnos</p>
            </div>
            <div className="bg-[#152035] border border-blue-500/20 p-6 rounded-2xl hover:border-cyan-500/30 transition-colors">
               <div className="text-3xl mb-4">⚡</div>
               <h3 className="font-bold text-lg mb-2">Sin fricción técnica</h3>
               <p className="text-gray-400 text-sm">Tu academia lista en minutos sin programar</p>
            </div>
            <div className="bg-[#152035] border border-blue-500/20 p-6 rounded-2xl hover:border-cyan-500/30 transition-colors">
               <div className="text-3xl mb-4">🔒</div>
               <h3 className="font-bold text-lg mb-2">Pagos seguros con Stripe</h3>
               <p className="text-gray-400 text-sm">Infraestructura de cobro integrada</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* PLANES */}
      <section className="py-20 px-10 bg-[#070d1a] relative">
         ...
         <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
             ...
             <p className="text-gray-400 max-w-2xl mx-auto">Selecciona el plan que se adapte al tamaño de tu academia.</p>
          </div>
      ...
      {/* FOOTER MULTICOLUMNA */}
      <footer className="border-t border-blue-500/20 bg-[#0a1f44] pt-16 pb-8 px-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
           <div>
              ...
              <p className="text-gray-400 text-sm mb-6 max-w-xs">La infraestructura SaaS para que profesores universitarios creen, vendan y escalen su conocimiento en línea.</p>
