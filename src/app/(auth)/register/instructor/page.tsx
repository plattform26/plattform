  ...
  return (
    <div className="min-h-screen py-12 px-6 flex flex-col items-center justify-center bg-[#070d1a] text-white">
      ...
      <div className="max-w-md w-full p-10 bg-[#0d1524] border border-blue-500/20 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        <Link href="/register" className="text-xs font-bold text-cyan-400 hover:text-white mb-6 inline-flex items-center gap-2 transition-colors uppercase tracking-widest leading-none">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-space-grotesk font-bold text-white mb-2">Crear mi Academia</h2>
          <p className="text-gray-400 text-sm font-light leading-relaxed">Configura tu infraestructura y empieza a vender conocimiento.</p>
        </div>
        
        {searchParams?.canceled && (
          <div className="bg-yellow-500/10 border border-yellow-500/50 text-yellow-400 p-4 rounded-xl mb-6 text-xs font-semibold animate-shake">
            ⚠️ Cancelaste el proceso de pago. Tu cuenta quedó pendiente.
          </div>
        )}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input 
                type="text" 
                required 
                placeholder="Dr. Alejandro"
                className="block w-full px-4 py-3 bg-[#152035] border border-blue-500/10 rounded-xl focus:outline-none focus:border-cyan-500 text-white transition-all placeholder:text-gray-600" 
